    ...
    <Document>
      <Page size="A4" style={styles.page}>
          ...
          {samplesProcessed.length === 0 ? (
            ...
            <>
              <View style={styles.tableHeader}>
                ...
                <Text style={[styles.colLapid, styles.colHeader]}>LAPID</Text>
              ...
              {samplesProcessed.map((sample) => (
                <View key={sample.sampleId} style={styles.tableRow}>
                  ...
                  <Text style={styles.colLapid}>{sample.lapid}</Text>
            ...
            <>
              ...
              {resultsIssued.map((result) => (
                <View key={result.sampleId} style={styles.tableRow}>
                  ...
                  <Text style={styles.colLapid}>{result.lapid}</Text>
        ...
        <View style={styles.footer}>
          <Text style={styles.footerText}>Generated by Labora AI</Text>
